...
export const stafiStakedETHAbi = [
  {
    inputs: [{ internalType: 'address', name: '_stafiStorageAddress', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  {
  ...
  { inputs: [], name: 'depositExcess', outputs: [], stateMutability: 'payable', type: 'function' },
  { inputs: [], name: 'depositRewards', outputs: [], stateMutability: 'payable', type: 'function' },
  {
    inputs: [],
    name: 'getBurnEnabled',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
...
export const lockedAGIWETHLPPoolAbi = [
  {
    inputs: [
      { internalType: 'address', name: '_owner', type: 'address' },
      { internalType: 'address', name: '_stakingToken', type: 'address' },
      { internalType: 'string[]', name: '_rewardSymbols', type: 'string[]' },
      { internalType: 'address[]', name: '_rewardTokens', type: 'address[]' },
      { internalType: 'address[]', name: '_rewardManagers', type: 'address[]' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'secs', type: 'uint256' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'destination_address', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'user', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'secs', type: 'uint256' },
      { indexed: false, internalType: 'bytes32', name: 'kek_id', type: 'bytes32' },
      { indexed: false, internalType: 'address', name: 'source_address', type: 'address' },
    ],
    name: 'StakeLocked',
    type: 'event',
  },
  ...
  { inputs: [], name: 'acceptOwnership', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'old_combined_weight', type: 'uint256' },
      { internalType: 'uint256', name: 'new_combined_weight', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'address', name: 'reward_token_address', type: 'address' },
      { internalType: 'address', name: 'new_manager_address', type: 'address' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'getRewardForDuration',
    outputs: [{ internalType: 'uint256[]', name: 'rewards_per_duration_arr', type: 'uint256[]' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      {
        ...
        internalType: 'struct AGILITYFarm.LockedStake[]',
        name: '',
        type: 'tuple[]',
      },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256[]', name: 'newRewardsPerTokenStored', type: 'uint256[]' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_lock_time_for_max_multiplier', type: 'uint256' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_lock_max_multiplier', type: 'uint256' }],
    name: 'setMultipliers',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'address', name: 'reward_token_address', type: 'address' },
      { internalType: 'uint256', name: 'new_rate', type: 'uint256' },
  ...
  { inputs: [], name: 'toggleRewardsCollection', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  { inputs: [], name: 'toggleStaking', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  { inputs: [], name: 'toggleWithdrawals', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
...
export type AGIContractType = typeof AGIAbi;
